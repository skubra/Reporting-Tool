...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_HOST', '192.168.2.29'),
            'port' => env('DB_PORT', '4831'),
            'database' => env('DB_DATABASE', 'TEST_KPI_RAPOR'),
            'username' => env('DB_USERNAME', 'kpi_user'),
            'password' => env('DB_PASSWORD', 'UlasimKpi18!'),
            'charset' => 'utf8',
            'prefix' => '',
        ],
